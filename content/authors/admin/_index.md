...
Specifically, I focus on developing hybrid control architectures that seamlessly integrate model-based methods—such as Model Predictive Control (MPC), Sliding Mode Control (SMC), and robust/adaptive control—with data-driven techniques like Residual Reinforcement Learning, Radial Basis Function Networks (RBFNNs), and Meta-Critic guided learning. I aim to enhance the reliability and adaptability of intelligent systems operating in uncertain, dynamic environments by leveraging the complementary strengths of structured control and learning-based components. Beyond algorithms, I am also deeply interested in the physical layer of interaction between autonomous agents and their environments. This includes exploring how Frequency-Selective Surfaces (FSS) and Reconfigurable Intelligent Surfaces (RIS) can be actively controlled through AI-driven strategies to optimize wireless communication, localization, and coordination in robotic systems. Additionally, I investigate the integration of neural radiance fields (NeRF) to enable high-fidelity visual scene understanding for more informed planning and control.
